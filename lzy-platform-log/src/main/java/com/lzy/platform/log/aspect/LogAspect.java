package com.lzy.platform.log.aspect;

import com.lzy.platform.base.annotation.log.AfterLog;
import com.lzy.platform.base.annotation.log.AroundLog;
import com.lzy.platform.base.annotation.log.BeforeLog;
import com.lzy.platform.base.constant.LogLevelConstant;
import com.lzy.platform.base.domain.LzyCloudLog;
...
public class LogAspect {
     ...
     * Before切点
     */
    @Pointcut("@annotation(com.lzy.platform.base.annotation.log.BeforeLog)")
     ...
     * After切点
     */
    @Pointcut("@annotation(com.lzy.platform.base.annotation.log.AfterLog)")
     ...
     * Around切点
     */
    @Pointcut("@annotation(com.lzy.platform.base.annotation.log.AroundLog)")
    ...
    public void addSysLog(JoinPoint joinPoint, String inParams, String outParams, String operationName) throws Exception {
        try {
            ...
            LzyCloudLog lzyCloudLog = new LzyCloudLog();
            lzyCloudLog.setLogType("1");
            lzyCloudLog.setMethodName(joinPoint.getSignature().getName());
            lzyCloudLog.setInParams(String.valueOf(inParams));
            lzyCloudLog.setOutParams(String.valueOf(outParams));
            lzyCloudLog.setOperationIp(ip);
            lzyCloudLog.setOperationName(operationName);
            log.log(LogLevelConstant.OPERATION_LEVEL, LogLevelConstant.OPERATION_LEVEL_MESSAGE, JsonUtils.objToJson(lzyCloudLog));
        } catch (Exception e) {
