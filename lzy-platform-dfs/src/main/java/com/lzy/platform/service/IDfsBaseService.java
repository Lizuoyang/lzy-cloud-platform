package com.lzy.platform.service;
...
public interface IDfsBaseService {
     ...
     * @return
     */
    LzyCloudDfsFile uploadFile(InputStream inputStream, String fileName);
     ...
     * @return
     */
    LzyCloudDfsFile uploadFile(InputStream inputStream, String bucket, String fileName);
